...
public class EntityDetection 
{
    ...
    public EntityDetection(Transform entity, float radius, BoxCollider2D boxCollider)
    {
        this.entity = entity;
        this.radius = radius;
        this.boxCollider2D = boxCollider;
    }
    ...
    private bool CanSeeObject(Collider2D obj)
    {
        ...
        Vector3 objectPosition = obj.transform.parent.position;
